...
class DeveloperPreview{
    ...
    let stat1 = StatisticModel(title: "Market Cap", value: "$22.6Bn", percentageChange: 25.34)
    let stat2 = StatisticModel(title: "Total Volume", value: "$60.7Bn")
    let stat3 = StatisticModel(title: "Portfolio Value", value: "$100", percentageChange: -2.6)
